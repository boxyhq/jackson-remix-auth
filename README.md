...
<pre>
curl --location --request POST 'http://localhost:3000/api/v1/saml/config' \
...
5. `/auth/saml/callback` (hosted),`/auth/saml/embed/callback` (embedded)- Handles the redirection from the SAML Service Provider.
